...
function showPanel(context, statusMessage = "") {
  ...
  container.innerHTML = `
    ...
    <div class="pra-muted">Yellow: exact duplicate | Red: creator handle | Orange: contradiction | Purple: overlapping meaning | Blue: repeated word</div>
